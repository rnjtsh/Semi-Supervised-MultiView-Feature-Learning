...
def main():
    ...
    for filename in os.listdir(path):
        ...
        # utf-8 could be used instead of "windows-1252"
        ...
        word_tokens = tokenizer.tokenize(
            htmlSource.lower())   # Changes to lower case
        # stemming is being done
        ...
        # Appends the entire text of a webpage into text_container
    ...
    class_one_test_samples = int(class_one_samples_count * 0.3)
    test_tf_idf_matrix = tf_idf_matrix_with_labels[0:class_one_test_samples, :]
    class_two_test_samples = int(class_two_samples_count * 0.3)
    temp_test_tf_idf_matrix = tf_idf_matrix_with_labels[class_one_samples_count:(
        class_one_samples_count+class_two_samples_count), :]
    test_tf_idf_matrix = np.concatenate(
        (test_tf_idf_matrix, temp_test_tf_idf_matrix), axis=0)
    temp_matrix1 = tf_idf_matrix_with_labels[class_one_test_samples:class_one_samples_count, :]
    temp_matrix2 = tf_idf_matrix_with_labels[(
        class_one_samples_count+class_two_samples_count):, :]
